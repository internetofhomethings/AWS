...
public:
    ...
    void operator()(char* result, const void* data, size_t numBytes);
    /// compute SHA256 of a string, excluding final zero
    /* Modified from original source code. Using char* instead of string. */
    void operator()(char* result, const char* text);

    void getHashVal(char* result, char* text);

    void getHashValB(char* result, char* text, size_t numBytes);
